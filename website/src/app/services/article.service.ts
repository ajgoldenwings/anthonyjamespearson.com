...
export class ArticleService {
  private articles: Article[] = [
    {
      ...
      date: '2026-01-09',
      description: "A developer's experiment with AI reveals how artificial intelligence might reshape software creation"
    },
    {
    ...
    },
    {
      ...
      date: '2016-05-16',
      description: 'Upload your site here and actually see it up on the web. We will not make a custom domain name in this one. Next post will be. Just you wait, but look at this one before if you did not read it unless your smart at signing in into things.'
    },
    {
  ...
  getAllArticles(): Article[] {
    return this.articles.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime());
  }
